...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Cdefs%3E%3CfilterColor id='neon-glow'%3E%3CfeGaussianBlur stdDeviation='2.5' result='coloredBlur'/%3E%3CfeMerge%3E%3CfeMergeNode in='coloredBlur'/%3E%3CfeMergeNode in='SourceGraphic'/%3E%3C/feMerge%3E%3C/filter%3E%3ClinearGradient id='bgGrad' x1='0%25' y1='0%25' x2='100%25' y2='100%25'%3E%3CstopOffset='0%25' style='stop-color:%230f0f1e;stop-opacity:1'/%3E%3CstopOffset='100%25' style='stop-color:%231a1a2e;stop-opacity:1'/%3E%3C/linearGradient%3E%3C/defs%3E%3Crect fill='url(%23bgGrad)' width='100' height='100'/%3E%3Ccircle cx='50' cy='50' r='48' fill='none' stroke='%2339ff14' stroke-width='1.5' opacity='0.4'/%3E%3Ctext x='50' y='72' font-size='75' font-weight='bold' font-family='monospace' fill='%2339ff14' text-anchor='middle' filter='url(%23neon-glow)' style='text-shadow: 0 0 8px %2339ff14, 0 0 16px %2339ff14, 0 0 24px %2339ff14;'%3EC%3C/text%3E%3Crect x='20' y='20' width='60' height='60' fill='none' stroke='%2339ff14' stroke-width='0.8' opacity='0.3'/%3E%3C/svg%3E">
